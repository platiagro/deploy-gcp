...
const initialState = {
  ...
  versionList: [
    {
      value: 'https://raw.githubusercontent.com/platiagro/manifests/v0.1.0-kubeflow-v1.0-branch/kfdef/kfctl_platiagro_tls.v0.1.0.yaml',
      text: 'PlatIAgro v0.1.0'
    },
    {
      value: 'https://raw.githubusercontent.com/platiagro/manifests/feature/dojot-installer/kfdef/kfctl_platiagro_tls.v0.1.0_dojot.v0.4.3.yaml',
      text: 'PlatIAgro v0.1.0 + dojot v0.4.3'
    },
  ],
  projectId: '',
  zone: 'us-central1-a',
